...
# Разбиваем диски (для ручной разметки используем fdisk, для псевдографической разбивки можно использовать команду 
 cfdisk)
...
#################################################
           ***Теперь установка иксов и собственно видео***
#################################################
