...
###########################################################################
##############################################
Если при установке Arch Linux у кого-то нет второго телефона или компа, то можно прям на этом же компе набрать команду
## less install.txt
и вы получите актуальную версию установки Arch Linux (Копию Arch Wiki на англ.)
...
***************hostnamectl set-hostname achlinuxname ****************
№№№№№ посмотреть что получилось: hostnamectl №№№№№№
***********************************************************************
 или так по старому: echo "ArchLinuxname" > /etc/hostname
*************************************************************************
 nano /etc/hosts 
...
# И Устанавливаем загрузчик  (для BIOS)
pacman -S grub
...
###################################
(Можно попробывать проверить загрузчик)Запускаем менеджер загрузки:
