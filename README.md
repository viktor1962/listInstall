...
*********************************************************
1) /dev/sda1 - 550M EFI - Выставить флаг EFI командой t
2) /dev/sda2 - 32G root Linux File System
3) /dev/sda3 - 16G swap
4) /dev/sda4 - Весь остаток home Linux file System
...
***************************************************************************************************************************
# ****Разделы с UEFI****
# Форматирование дисков -Лучше не создавать SWAP!!!!!ИЗНОС ssd диска!
###########################################
...
5) mkdir /mnt/home
6) mkdir /mnt/boot
7) mkdir /mnt/boot/EFI
8) mount /dev/sda1 /mnt/boot/EFI
9) mount /dev/sda3 /mnt/home
***************************************************************************************************************************
№№№№№№№№№№№№№№№№ Смотрим разделы №№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№
...
****************************************************************************************************************************
****************************************************************************************************************************
# Или Поставим ДОПУСТИМ российское зеркало Яндекса выше всех остальных
...
pacstrap /mnt base base-devel linux linux-firmware nano netctl dhcpcd hdparm profile-sync-daemon
***************************************************************************************************************************
Проверь, поддерживается ли TRIM
     ################################
...
Используйте следующий флаг монтирования в вашем: nano /etc/fstab, чтобы получить преимущества команды TRIM:
#############################################################
...
######Компиляция в tmpfs
###
Перенос интенсивной компиляции в /tmp — отличная идея продления срока жизни диска. Если у вас имеется более 4ГБ оперативной памяти,
##
 #####строку tmp из /etc/fstab нужно изменить, чтобы раздел использовал больше половины доступной памяти, 
 ##
 через параметр size=, т. к. /tmp при компиляции растёт очень быстро.
#############################################
Пример для машины с 16ГБ оперативки:
############################################# Узнать ID и GID: $ id USER ####################################################
###########################################################################################################################
tmpfs /tmp tmpfs nodev,nosuid,size=8G,uid=1000,gid=985,mode=1777  0 0
##########################################################################################################################
...
№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№ Можно проверить: systemctl status tmp.mount №№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№
...
****************************************************************************************************************************
№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№№
          ****Здесь поможет клавиатурой 2 раза кликнуть: Tab ****
...
###########################################################################
 pacman -S xorg-server xorg-drivers xorg-xinit dialog
##########################################################################
...
pacman -S networkmanager network-manager-applet ppp pulseaudio pulseaudio-alsa firefox firefox-i18-ru firefox-spell-ru 
#################################
...
#####################################
Использование psd
Проверка конфигурации. Запуск с опцией 'parse' показывает что именно psd будет делать, основываясь на конфигурации в $XDG_CONFIG_HOME/psd/psd.conf,
